...
CREATE TABLE VIDEO (
    ...
    GeneroPrincipal TEXT DEFAULT 'NULL',
    NumVisualizacoes INTEGER CHECK (NumVisualizacoes >= 0), -- os atributos derivados não precisam de ser atributos da BD!
...
CREATE TABLE COMENTARIO (
    ...
    CONSTRAINT COM_USER_FK FOREIGN KEY(LogUser_Id) REFERENCES USERIDENTIFICADO(LogUser_Id) ON DELETE SET NULL ON DELETE CASCADE
);
...
CREATE TABLE SUBSCRICAO (
    ...
    Tipo TEXT NOT NULL CHECK (Tipo = 'Premium' or TIPO = 'Basic'), -- Atenção: Tipo e TIPO!!
