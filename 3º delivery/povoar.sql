...
INSERT INTO PESSOA(Id_Pessoa, Id_Pais) VALUES (2, 2);
INSERT INTO PESSOA(Id_Pessoa, Ip, Id_Pais) VALUES (3, '79.42.181.219', 2);
INSERT INTO PESSOA(Id_Pessoa, TipoDispositivo, Id_Pais) VALUES (4, 'Tablet Android', 9);
INSERT INTO PESSOA(Id_Pessoa, TipoDispositivo, Id_Pais) VALUES (5, 'Computador Ios', 2);
INSERT INTO PESSOA VALUES (6, '250.62.149.132', 'Computador Windows', 1);
INSERT INTO PESSOA(Id_Pessoa, Ip, Id_Pais) VALUES (7, '173.92.220.86', 2);
...
INSERT INTO PESSOA(Id_Pessoa, TipoDispositivo, Id_Pais) VALUES (14, 'Tablet Ios', 7);
INSERT INTO PESSOA VALUES (15, '238.37.25.158', 'Tablet Ios', 3);  


--------------------USERIDENTIFICADO-------------------------

INSERT INTO USERIDENTIFICADO(LogUser_Id, Ip, NomeCanal, Password, EmailAssociado, DataCriacao, NumSubscritores) VALUES(1, '152.78.204.183', 'FunnyVids', '09OP56473', 'gtuann@pickuplanet.com', '2014-05-05', 2);
INSERT INTO USERIDENTIFICADO(LogUser_Id, NomeCanal, Password, EmailAssociado, DataCriacao, NumSubscritores) VALUES(2, 'SchoolAcademy', '15469785695A', 'vkumarrudra@furnitt.com', '2017-05-12', 2);
INSERT INTO USERIDENTIFICADO(LogUser_Id, Ip, NomeCanal, Password, EmailAssociado, DataCriacao, NumSubscritores) VALUES(3, '79.42.181.219', 'Pewdiepie', '54teydbwu762', '1ilyass-soloxu@duybuy.com', '2010-04-29', 3);
INSERT INTO USERIDENTIFICADO(LogUser_Id, TipoDispositivo, NomeCanal, Password, EmailAssociado, DataCriacao, NumSubscritores) VALUES(4, 'Tablet Android', 'ESL', 'ajsfbf8673', '2leonardo121@taluabushop.com', '2017-06-08', 2);
...
INSERT INTO USERIDENTIFICADO VALUES (6, '250.62.149.132', 'Computador Windows', 'RicFazeres', 'ZBRg#TBf7^J=8rSV', 'aehabhoba449l@laldo.com', '2006-05-17', 1);
INSERT INTO USERIDENTIFICADO(LogUser_Id, Ip, NomeCanal, Password, EmailAssociado, DataCriacao, NumSubscritores) VALUES (7, '173.92.220.86', 'Unbox Therapy', 'nV4puxC*hw5xDPaK', 'jedward.afm@findoasis.com', '2011-05-16', 4);
...
INSERT INTO USERIDENTIFICADO VALUES (9, '245.126.98.79', 'Smartphone Android', 'Marques Brownlee', '5pLWtt?yK=d$^BRP', 'iste@pesssink.com', '2011-03-11', 7);
...
INSERT INTO VIDEO(Id_Video, Link, Titulo, GeneroPrincipal, NumVisualizacoes , NumLikes, NumDislikes, NumComentarios, NumPartilhas, Duracao) VALUES(4, 'https://platfo.rm/pqflenfi7t3', 'Basic SQL commands', 'Learning', 0, 2, 0, 0, 0, 4856);
...
INSERT INTO VIDEO(Id_Video, Link, Titulo, GeneroPrincipal, NumVisualizacoes , NumLikes, NumDislikes, NumComentarios, NumPartilhas, Duracao) VALUES(7, 'https://platfo.rm/qwefoiygi3s', 'CS:GO - Cloud9 vs. SK [Inferno] Map 3 - Grand Final', 'Gaming', 2, 2, 1, 2, 1, 5041);
...
INSERT INTO COMENTARIO(Id_Coment, String, NumLikes, NumDislikes, Id_Video, LogUser_Id) VALUES(10, 'Great stuff m8', 0, 0, 12, 3);
INSERT INTO COMENTARIO VALUES(11, 'Poor Ethan', 1, 0, 13, 1); 


-------------LISTA DE REPRODUCAO---------------------------------

INSERT INTO LISTADEREPRODUCAO(Id_Lista, Nome, NumVideos, DuracaoTotal, Estado, LogUser_Id) VALUES(1, 'Watch later', 2, 484, 'Pública', 4);
INSERT INTO LISTADEREPRODUCAO(Id_Lista, Nome, NumVideos, DuracaoTotal, Estado, LogUser_Id) VALUES(2, 'Favorites', 2, 6903, 'Privada', 4);
INSERT INTO LISTADEREPRODUCAO(Id_Lista, Nome, NumVideos, DuracaoTotal, Estado, LogUser_Id) VALUES(3, 'Funny Videos', 2, 1934, 'Privada', 3);
INSERT INTO LISTADEREPRODUCAO(Id_Lista, Nome, NumVideos, DuracaoTotal, Estado, LogUser_Id) VALUES(4, 'Songs', 2, 3705, 'Privada', 2);
INSERT INTO LISTADEREPRODUCAO(Id_Lista, Nome, NumVideos, DuracaoTotal, Estado, LogUser_Id) VALUES(5, 'Future Vaccation', 1, 320, 'Privada', 1);
INSERT INTO LISTADEREPRODUCAO(Id_Lista, Nome, NumVideos, DuracaoTotal, Estado, LogUser_Id) VALUES(6, 'Random stuff', 1, 320, 'Pública', 2); 
...
INSERT INTO CLASSIFICACAO(LogUser_Id, Id_Video, Tipo) VALUES(4, 2, 'Dislike');
...
INSERT INTO VISUALIZACAO VALUES (1, 13, 7993);
...
INSERT INTO VISUALIZACAO VALUES (9, 13, 7993);
...
INSERT INTO INFOVIDEOLISTA(Id_Lista, Id_Video, DataAdicao) VALUES(1, 1, '2019-05-09');
INSERT INTO INFOVIDEOLISTA(Id_Lista, Id_Video, DataAdicao) VALUES(1, 3, '2018-06-09');
INSERT INTO INFOVIDEOLISTA(Id_Lista, Id_Video, DataAdicao) VALUES(2, 1, '2017-05-09');
INSERT INTO INFOVIDEOLISTA(Id_Lista, Id_Video, DataAdicao) VALUES(2, 2, '2018-06-09');
INSERT INTO INFOVIDEOLISTA(Id_Lista, Id_Video, DataAdicao) VALUES(2, 3, '2016-05-09');
INSERT INTO INFOVIDEOLISTA(Id_Lista, Id_Video, DataAdicao) VALUES(2, 4, '2018-11-09');
INSERT INTO INFOVIDEOLISTA(Id_Lista, Id_Video, DataAdicao) VALUES(3, 5, '2019-05-09');
INSERT INTO INFOVIDEOLISTA(Id_Lista, Id_Video, DataAdicao) VALUES(3, 6, '2018-06-09');
INSERT INTO INFOVIDEOLISTA(Id_Lista, Id_Video, DataAdicao) VALUES(4, 6, '2019-05-09');
INSERT INTO INFOVIDEOLISTA(Id_Lista, Id_Video, DataAdicao) VALUES(4, 7, '2018-06-09');
INSERT INTO INFOVIDEOLISTA(Id_Lista, Id_Video, DataAdicao) VALUES(5, 1, '2020-05-09');
INSERT INTO INFOVIDEOLISTA(Id_Lista, Id_Video, DataAdicao) VALUES(6, 1, '2020-06-09');
...
INSERT INTO CRIADOR(DataCarregamento, DataPublicacao, TransmissaoDireto, Id_Video, LogUser_Id) VALUES('2020-05-13', '2020-05-14', 'Sim', 3, 1);
...
INSERT INTO CRIADOR(DataCarregamento, DataPublicacao, TransmissaoDireto, Id_Video, LogUser_Id) VALUES('2021-03-01', '2021-03-01', 'Não', 5, 1);
...
INSERT INTO CRIADOR(DataCarregamento, DataPublicacao, TransmissaoDireto, Id_Video, LogUser_Id) VALUES('2021-02-16', '2021-02-17', 'Sim', 7, 4);
INSERT INTO CRIADOR VALUES('2021-04-27', '2021-04-27', 'Não', 8, 5);
INSERT INTO CRIADOR VALUES('2016-08-19', '2016-08-20', 'Não', 9, 6);
INSERT INTO CRIADOR VALUES('2021-03-23', '2021-03-23', 'Não', 10, 7);
INSERT INTO CRIADOR VALUES('2021-04-01', '2021-04-01', 'Não', 11, 9);
INSERT INTO CRIADOR VALUES('2020-12-31', '2020-12-31', 'Não', 12, 10);
INSERT INTO CRIADOR VALUES('2019-10-27', '2019-10-28', 'Sim', 13, 8);
